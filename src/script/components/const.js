...
export const nameForm = document.querySelector("#heading");
export const profForm = document.querySelector("#subheading");
...
export const popupFormNewAva = document.querySelector('#popupFormNewAva');
